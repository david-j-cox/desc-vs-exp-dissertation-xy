...
import FinalChoiceBlueOrange from "@/components/phases/final-choice-blue-orange"
...
export default function TestChoicePage() {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (!storedData) {
        const mockData: ExperimentData = {
          participantId: "",
          currentPhase: "final-choice-blue-orange" as Phase,
          trials: [],
          totalPoints: 0
        }
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Final Choice Test Page</h1>
